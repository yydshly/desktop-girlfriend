...
class TestReadVersion:
    ...
    def test_read_version_missing_file() -> None:
        assert read_version(Path("/nonexistent/version/file")) == "0.3.0-alpha.1"
...
class TestGetAppVersion:
    ...
    def test_get_app_version_version() -> None:
        ver = get_app_version()
        assert ver.version == "0.3.0-alpha.1"
...
class TestProductStatusBuilder:
    ...
    def test_build_with_app_version_includes_version() -> None:
        ...
        assert "版本" in labels
        assert "0.3.0-alpha.1" in details
